...
void vid_SetLCDPins(LCDNumber* PstructLCDNbCpy , u16 u16NumCpy )
{
	...
	PstructLCDNbCpy[0].RS=DIO_u8PIN_31;
	PstructLCDNbCpy[0].RW=DIO_u8PIN_30;
	PstructLCDNbCpy[0].E =DIO_u8PIN_29;
	PstructLCDNbCpy[0].Data[0]=DIO_u8PIN_20;
	PstructLCDNbCpy[0].Data[1]=DIO_u8PIN_21;
	PstructLCDNbCpy[0].Data[2]=DIO_u8PIN_22;
	PstructLCDNbCpy[0].Data[3]=DIO_u8PIN_23;
	PstructLCDNbCpy[0].Data[4]=DIO_u8PIN_7;
	PstructLCDNbCpy[0].Data[5]=	DIO_u8PIN_6;
	PstructLCDNbCpy[0].Data[6]=	DIO_u8PIN_5;
	PstructLCDNbCpy[0].Data[7]=	DIO_u8PIN_4;
