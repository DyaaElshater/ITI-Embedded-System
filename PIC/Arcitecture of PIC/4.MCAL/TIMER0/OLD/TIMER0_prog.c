...
void TIMER0_vidInit()
{
  TIMER0_T0CON = TIMER0_MODE | TIMER0_SOURCE | TIMER0_SOURCE_EDGE |
     ...
     u32OvfTime =  (/*1.0*/ 1.0 /TIMER0_CPU_Frquency)*Resolution ;
  #elif TIMER0_PRESCALLER ==  TIMER0_DIV_BY_2
     u32OvfTime =  (/*2.0*/ 1.0 /TIMER0_CPU_Frquency)*Resolution ;
  #elif TIMER0_PRESCALLER ==  TIMER0_DIV_BY_4
     u32OvfTime =  (/*4.0*/ 1.0 /TIMER0_CPU_Frquency)*Resolution ;
  #elif TIMER0_PRESCALLER == TIMER0_DIV_BY_8
     u32OvfTime =  (/*8.0*/ 1.0 /TIMER0_CPU_Frquency)*Resolution ;
  #elif TIMER0_PRESCALLER == TIMER0_DIV_BY_16
     u32OvfTime =  (/*16.0*/ 1.0/TIMER0_CPU_Frquency)*Resolution ;
  #elif TIMER0_PRESCALLER == TIMER0_DIV_BY_32
     u32OvfTime =  (/*32.0*/ 1.0/TIMER0_CPU_Frquency)*Resolution ;
  #elif TIMER0_PRESCALLER == TIMER0_DIV_BY_64
     u32OvfTime =  (/*64.0*/ 1.0/TIMER0_CPU_Frquency)*Resolution ;
  #elif TIMER0_PRESCALLER == TIMER0_DIV_BY_128
     u32OvfTime =  (/*128.0*/1.0/TIMER0_CPU_Frquency)*Resolution ;
  #elif TIMER0_PRESCALLER == TIMER0_DIV_BY_256
     u32OvfTime =  (/*256.0*/1.0/TIMER0_CPU_Frquency)*Resolution ;
  #else
