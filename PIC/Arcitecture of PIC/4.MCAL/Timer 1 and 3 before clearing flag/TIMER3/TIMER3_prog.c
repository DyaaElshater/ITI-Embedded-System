...
void TIMER3_vidInit()
{
     ...
     u32OvfTime =  (/*1.0*/ 0.053*1.0 /TIMER3_CPU_Frquency)*Resolution ;
  #elif TIMER3_PRESCALLER ==  TIMER3_DIV_BY_2
     u32OvfTime =  (/*2.0*/ 0.0265*2.0 /TIMER3_CPU_Frquency)*Resolution ;
  #elif TIMER3_PRESCALLER ==  TIMER3_DIV_BY_4
     u32OvfTime =  (/*4.0*/ 0.01325*4.0 /TIMER3_CPU_Frquency)*Resolution ;
  #elif TIMER3_PRESCALLER == TIMER3_DIV_BY_8
     u32OvfTime =  (/*8.0*/ 0.006625*8.0/TIMER3_CPU_Frquency)*Resolution ;
  #else
